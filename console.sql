...
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (1, 'Wordware', 2258279.52, 'bushidonaruto', 'Professional', 5);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (2, 'Plajo', 6473405.66, 'DrawDenied_Twitch', 'Professional', 35);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (3, 'Livefish', 858619.17, 'may6enexttime', 'Professional', 16);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (4, 'Gigashots', 8472207.11, 'Drvitman', 'Professional', 3);
...
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (6, 'Ntag', 819356.01, 'penguingim1', 'Professional', 5);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (7, 'Edgeclub', 2169974.59, 'Ragehunter', 'Professional', 22);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (8, 'Rhynyx', 5612071.5, 'VincentKeymer2004', 'Professional', 20);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (9, 'Ainyx', 3128949.94, 'Arka50', 'Professional', 3);
...
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (11, 'Eayo', 7802660.21, 'penguingim1', 'Professional', 4);
...
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (15, 'Yakidoo', 4931171.53, 'VincentKeymer2004', 'Professional', 19);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (16, 'BlogXS', 1463993.27, 'KontraJaKO', 'Professional', 12);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (17, 'Kwimbee', 1461055.21, 'Ragehunter', 'Professional', 5);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (18, 'Feedspan', 6222026.45, 'VincentKeymer2004', 'Professional', 26);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (19, 'Yoveo', 2942753.79, 'igormezentsev', 'Professional', 14);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (20, 'Latz', 7368728.67, 'chessmaster2006', 'Professional', 10);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (21, 'Meevee', 7961704.84, 'VincentKeymer2004', 'Professional', 30);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (22, 'Flashset', 9861755.96, 'nihalsarin2004', 'Professional', 22);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (23, 'Wordpedia', 5631265.71, 'igormezentsev', 'Professional', 5);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (24, 'Dabshots', 941728.99, 'nihalsarin2004', 'Professional', 18);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (25, 'Cogidoo', 6459484.1, 'DrVelja', 'Professional', 16);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (26, 'Zoomzone', 7617020.66, 'LastGladiator2', 'Professional', 24);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (27, 'Wikibox', 1152305.86, 'Arka50', 'Professional', 3);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (28, 'Edgeify', 972040.59, 'penguingim1', 'Professional', 7);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (29, 'Jetwire', 274837.71, 'SVODMEVKO', 'Professional', 17);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (30, 'Gabvine', 2841335.26, 'SVODMEVKO', 'Professional', 23);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (31, 'Rhybox', 860622.86, 'nihalsarin2004', 'Professional', 5);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (32, 'Skinix', 1241733.13, 'DrVelja', 'Professional', 33);
...
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (34, 'Demimbu', 4916888.51, 'Azumilover', 'Professional', 20);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (35, 'Zoozzy', 8994399.11, 'KontraJaKO', 'Professional', 1);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (36, 'Mybuzz', 6895143.42, 'VincentKeymer2004', 'Professional', 24);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (37, 'Jetpulse', 2836812.75, 'VincentKeymer2004', 'Professional', 8);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (38, 'Edgewire', 810411.42, 'Inventing_Invention', 'Professional', 3);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (39, 'Meetz', 2791685.91, 'Arka50', 'Professional', 24);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (40, 'Feedmix', 5063534.73, 'muisback', 'Professional', 21);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (41, 'Oyoyo', 2622324.71, 'VincentKeymer2004', 'Professional', 26);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (42, 'Skinte', 3990477.75, 'Watneg', 'Professional', 7);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (43, 'Jaxspan', 5195976.49, 'Inventing_Invention', 'Professional', 28);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (44, 'Fivebridge', 6918590.86, 'igormezentsev', 'Professional', 8);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (45, 'Fliptune', 590511.65, 'chessmaster2006', 'Professional', 22);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (46, 'Babblestorm', 6963407.6, 'Azumilover', 'Professional', 4);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (47, 'Dynabox', 9461786.1, 'KontraJaKO', 'Professional', 18);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (48, 'Ntags', 4101069.36, 'Azumilover', 'Professional', 12);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (49, 'Voolia', 1273643.35, 'KontraJaKO', 'Professional', 5);
insert into advertiser (advertiserID, companyName, totalSpent, topUser, userPreference, salesID) values (50, 'Realcube', 3275990.28, 'ARM__55555', 'Professional', 6);
...
insert into userLibrary (libraryID, gameID, userID) values (19, 52, 1);
insert into userLibrary (libraryID, gameID, userID) values (20, 5, 12);
insert into userLibrary (libraryID, gameID, userID) values (21, 33, 2);
insert into userLibrary (libraryID, gameID, userID) values (22, 40, 13);
insert into userLibrary (libraryID, gameID, userID) values (23, 28, 19);
insert into userLibrary (libraryID, gameID, userID) values (24, 23, 10);
insert into userLibrary (libraryID, gameID, userID) values (25, 42, 4);
insert into userLibrary (libraryID, gameID, userID) values (26, 24, 7);
insert into userLibrary (libraryID, gameID, userID) values (27, 50, 24);
insert into userLibrary (libraryID, gameID, userID) values (28, 39, 6);
insert into userLibrary (libraryID, gameID, userID) values (29, 47, 4);
insert into userLibrary (libraryID, gameID, userID) values (30, 27, 24);
...
insert into userLibrary (libraryID, gameID, userID) values (34, 38, 27);
insert into userLibrary (libraryID, gameID, userID) values (35, 47, 8);
insert into userLibrary (libraryID, gameID, userID) values (36, 43, 8);
insert into userLibrary (libraryID, gameID, userID) values (37, 7, 6);
insert into userLibrary (libraryID, gameID, userID) values (38, 50, 24);
insert into userLibrary (libraryID, gameID, userID) values (39, 27, 23);
insert into userLibrary (libraryID, gameID, userID) values (40, 34, 27);
insert into userLibrary (libraryID, gameID, userID) values (41, 28, 25);
insert into userLibrary (libraryID, gameID, userID) values (42, 35, 4);
insert into userLibrary (libraryID, gameID, userID) values (43, 14, 18);
insert into userLibrary (libraryID, gameID, userID) values (44, 42, 30);
insert into userLibrary (libraryID, gameID, userID) values (45, 50, 26);
insert into userLibrary (libraryID, gameID, userID) values (46, 32, 1);
insert into userLibrary (libraryID, gameID, userID) values (47, 41, 11);
insert into userLibrary (libraryID, gameID, userID) values (48, 3, 7);
insert into userLibrary (libraryID, gameID, userID) values (49, 24, 18);
insert into userLibrary (libraryID, gameID, userID) values (50, 9, 26);
insert into userLibrary (libraryID, gameID, userID) values (51, 44, 16);
insert into userLibrary (libraryID, gameID, userID) values (52, 4, 4);
insert into userLibrary (libraryID, gameID, userID) values (53, 29, 20);
